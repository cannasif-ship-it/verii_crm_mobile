...
export interface LineGroup {
  key: string;
  main: OrderLineDetailGetDto;
  related: OrderLineDetailGetDto[];
}

export function groupOrderLines(
  lines: OrderLineDetailGetDto[]
): LineGroup[] {
  const map = new Map<string, OrderLineDetailGetDto[]>();
...
function mapDetailLineToFormState(d: OrderLineDetailGetDto): OrderLineFormState {
  const base: OrderLineFormState = {
    id: `line-${d.id}`,
...
export function mapDetailLinesToFormState(
  ...
  const groups: OrderLineFormState[][] = [];
...
export function mapDetailRatesToFormState(
  rates: OrderExchangeRateDetailGetDto[],
...
export function mapExchangeRateFormStateToUpdateDtos(
  rates: OrderExchangeRateFormState[],
  orderId: number,
...
export function mapOrderLineFormStateToCreateDto(
...
export function mapOrderLineFormStateToUpdateDto(
  line: OrderLineFormState,
  orderId: number
): OrderLineUpdateDto | null {
