...
interface ExchangeRateDialogProps {
  ...
  offerDate?: string;
  useOrderRatesAsPrimary?: boolean;
}
...
export function ExchangeRateDialog({
  ...
  const [rates, setRates] = useState<OrderExchangeRateFormState[]>([]);
  ...
  useEffect(() => {
    ...
    setRates(merged);
  }, [visible, initialRates, erpExchangeRates, today, isLoadingErpRates, useOrderRatesAsPrimary]);
