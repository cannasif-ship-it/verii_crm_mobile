...
interface OrderDetailLineRowProps {
  line: OrderLineDetailGetDto;
  currency: string;
  isMain?: boolean;
  isRelated?: boolean;
}
...
function OrderDetailLineRowComponent({
  line,
  currency,
  isMain = false,
  isRelated = false,
  ...
  return (
    ...
    >
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("order.discount1")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("order.discount2")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("order.discount3")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
...
export const OrderDetailLineRow = memo(OrderDetailLineRowComponent);
