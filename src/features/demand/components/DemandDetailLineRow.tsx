...
function DemandDetailLineRowComponent({
  line,
  currency,
  isMain = false,
  isRelated = false,
  ...
  return (
    ...
    >
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("demand.discount1")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("demand.discount2")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
      ...
      <View style={styles.row}>
        <Text style={[styles.label, { color: colors.textMuted }]}>{t("demand.discount3")}:</Text>
        <Text style={[styles.value, { color: colors.text }]}>
...
export const DemandDetailLineRow = memo(DemandDetailLineRowComponent);
