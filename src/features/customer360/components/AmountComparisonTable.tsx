...
interface AmountComparisonTableProps {
  items: Customer360AmountComparisonDto[];
    ...
    <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
      ...
      <View style={[styles.table, { borderColor: colors.border }]}>
        <View style={styles.headerRow}>
          ...
          <Text style={[styles.headerCell, { color: colors.textMuted }]}>{last12Label}</Text>
          <Text style={[styles.headerCell, { color: colors.textMuted }]}>{openQuotationLabel}</Text>
          <Text style={[styles.headerCell, { color: colors.textMuted }]}>{openOrderLabel}</Text>
        </View>
        {list.map((row, index) => (
          <View
          ...
          >
            <Text style={[styles.cell, styles.cellCurrency, { color: colors.text }]}>
              {row.currency ?? "—"}
            </Text>
