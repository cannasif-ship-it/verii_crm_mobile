...
interface ApprovalRowProps {
  ...
  onApprove: (e: any, approval: ApprovalActionGetDto) => void;
  onReject: (e: any, approval: ApprovalActionGetDto) => void;
  isPending: boolean;
}
...
function ApprovalRowComponent({
  ...
  const handleApprovePress = (e: any): void => {
    e.stopPropagation();
    onApprove(e, approval);
  };

  const handleRejectPress = (e: any): void => {
    e.stopPropagation();
    onReject(e, approval);
  };
